...
Simply connected spaces have maximal isometry group, but in general the converse is false. In particular, we will focus on the case $K=-1$ and in that case it will be convenient to use non-simply connected models. 
