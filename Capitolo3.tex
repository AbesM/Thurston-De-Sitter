...
Recall the description of the left and right rulings of $\partial\A^{2,1}$ \textcolor{red}{inserire reference}, we can conclude that the endpoints of a spacelike geodesic and it's dual are mutually connected by lightlike segments in $\partial\A^{2,1}$. \textcolor{red}{ora lui dice di guardare due figure.}\\
