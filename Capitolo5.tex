...
\begin{lemma}
    Let $f:\S\to\S$ be an orientation-preserving homeomorphism, and let $(\alpha, \beta)\in \PSL\times\PSL$. Let us denote $K=\CF$ and $\hat{K}=(\alpha,\beta)\cdot\CF$ and let, \textcolor{red}{Pagina 14}
\end{lemma}
